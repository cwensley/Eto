...
public class ToggleButtonHandler : WinUIControl<Microsoft.UI.Xaml.Controls.Primitives.ToggleButton, ToggleButton, ToggleButton.ICallback>, ToggleButton.IHandler
{
	...
	static readonly Size DefaultMinimumSize = new(23, 23);
	...
	protected override Microsoft.UI.Xaml.Controls.Primitives.ToggleButton CreateControl() => new();
	...
	static muxm.ImageSource ToImageSource(Image image) => image switch
	{
		...
		_ => throw new NotSupportedException($"Image type '{image.GetType().FullName}' is not supported by Eto.WinUI toggle buttons.")
	};
}
