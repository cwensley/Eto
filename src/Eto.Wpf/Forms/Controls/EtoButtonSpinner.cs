	...
	public class EtoButtonSpinner : swc.ContentControl, IEtoWpfControl
	{
		...
		public override void OnApplyTemplate()
		{
			...
			if (increaseButton != null)
			{
				...
				increaseButton.PreviewMouseLeftButtonUp -= SpinButton_PreviewMouseLeftButtonUp;
			}
			if (decreaseButton != null)
			{
				decreaseButton.Click -= DecreaseButton_Click;
				decreaseButton.PreviewMouseLeftButtonUp -= SpinButton_PreviewMouseLeftButtonUp;
			}
		...
		void SpinButton_PreviewMouseLeftButtonUp(object sender, swi.MouseButtonEventArgs e)
		{
			if (Content is sw.UIElement content)
				content.Focus();
		}
